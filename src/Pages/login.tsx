...
function Login() {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div className= "bg-white shadow-2xl rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-48">
                ...
                <button aria-label="Continue with google" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10">
                    ...
                    <button onClick={signInWithGoogle} className="text-base font-medium ml-4 text-gray-700">Continue with Google</button>
                </button>
            </div>
        </div>
